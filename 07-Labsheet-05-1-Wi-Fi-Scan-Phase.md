...
* **ข้อจำกัด:** หาก Access Point (AP) เป้าหมายไม่ได้เปิดใช้งานอยู่บนช่องความถี่ที่ระบุระบบจะไม่สามารถตรวจพบ AP นั้นได้
...
* ค่า `authmode` เป็นสิ่งระบุประเภทความปลอดภัยและการเข้ารหัสของ AP 
* ESP32 จำเป็นต้องนำข้อมูลนี้ไปตั้งค่าในโครงสร้าง `wifi_config_t` ให้ตรงกับ AP ก่อนเริ่มกระบวนการเชื่อมต่อ หากกำหนดประเภทความปลอดภัยไม่ตรงกัน การทำ Authentication หรือ Handshake ในเฟสถัดไปจะล้มเหลวทันที
